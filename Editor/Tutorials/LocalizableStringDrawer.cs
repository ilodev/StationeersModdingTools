...
namespace ilodev.stationeersmods.tools.tutorial
{
    ...
    class LocalizableTextAreaDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            //if (property.propertyType == SerializedPropertyType.String)
            {
                ...
                string newValue = null;// EditorGUIProxy.ScrollableTextAreaInternal(position, value.stringValue, ref m_ScrollPosition, EditorStyles.textArea);
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            float fullTextHeight = EditorStyles.textArea.CalcHeight(GUIContent_Temp(text), 300);// EditorGUIProxy.contextWidth);
