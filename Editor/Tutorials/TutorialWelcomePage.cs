...
namespace ilodev.stationeersmods.tools.tutorial
{
    ...
    /// </remarks>
    [CreateAssetMenu(menuName = "My Assets/Tutorial Welcome")]
    public class TutorialWelcomePage : ScriptableObject
    {
        ...
        void OnValidate()
        {
            ...
            WindowTitle = SanitizeString(WindowTitle);
            Description = SanitizeString(Description);
        }

        private LocalizableString SanitizeString(LocalizableString input)
        {
            return input;
        }
